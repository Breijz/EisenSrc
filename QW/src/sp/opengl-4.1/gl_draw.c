...
void Draw_Character (int x, int y, int num)
{
	...
	float coord[] = {
		fcol,      frow,      x,   y,	1, 1, 1, 1,
		fcol+size, frow,      x+8, y,	1, 1, 1, 1,
		fcol+size, frow+size, x+8, y+8,	1, 1, 1, 1,
		fcol,      frow+size, x,   y+8, 1, 1, 1, 1
	};
	...
	glEnableVertexAtttribArray(0);
	glEnableVertexAtttribArray(1);
	glEnableVertexAtttribArray(2);

	glVertexAttribPointer(0, 2, GL_FLOAT, GL_FALSE, 2 * sizeof(float), (void*));
