...
void R_NetGraph (void)
{
	...
	// TEXCOORD(U,V) - POS(X,Y) - COLOOR(RGBA)
	// Is this odd? maybe; but its how the originial OpenGL code laid out their attributes; so I'll honour it
	float coords[] = {
		0, 0, x, 	       y,			1.0f, 1.0f, 1.0f, 1.0f,
		1, 0, x + NET_TIMINGS, y,			1.0f, 1.0f, 1.0f, 1.0f,
		1, 1, x + NET_TIMINGS, y+NET_GRAPHHEIGHT,	1.0f, 1.0f, 1.0f, 1.0f,
		0, 1, x,	       y+NET_GRAPHHEIGHT,	1.0f, 1.0f, 1.0f, 1.0f
	};
	...
	glVertexAttribPointer(2, 3, GL_FLOAT, GL_FALSE, 3 * sizeof(float), (void*)(4*sizeof(float)));
